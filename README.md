...
Este proyecto consiste en el modelado de una base de datos SQL. A continuación, se presenta el diagrama de entidad-relación que describe la estructura de la base de datos.
